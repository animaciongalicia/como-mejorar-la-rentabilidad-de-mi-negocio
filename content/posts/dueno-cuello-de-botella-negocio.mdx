...
Si te reconoces en esto, el siguiente artículo que tiene que interesarte es [el síndrome del empresario ocupado](/blog/sindrome-empresario-ocupado/): por qué el que trabaja más no gana más, y cómo salir de esa trampa. Para delegar de verdad necesitas que el equipo asuma responsabilidad — [cómo fijar objetivos sin que suenen a amenaza](/blog/como-fijar-objetivos-equipo-sin-que-suenen-a-amenaza/) te da el método. Y para que la delegación funcione, necesitas la autoridad que lo sostiene: [liderar con autoridad sin dar miedo](/blog/liderar-con-autoridad-sin-dar-miedo/) es la pieza que cierra el sistema.
