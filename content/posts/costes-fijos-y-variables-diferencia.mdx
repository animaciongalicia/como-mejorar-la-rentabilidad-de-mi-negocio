...
Hay dos preguntas que definen si un dueño de negocio gestiona o simplemente trabaja. La primera es: ¿sabes cuánto ganas de verdad cada mes? La segunda: ¿sabes cuáles de tus gastos se mueven con las ventas y cuáles tienes que pagar pase lo que pase?

Esta segunda pregunta es la de los costes fijos y variables. Y es más importante de lo que parece.
...
Si haces ese ejercicio y no te gustan los números que ves, es el momento de buscar ayuda. En **[consultoriametodo.es](https://consultoriametodo.es)** trabajamos con dueños de negocios físicos exactamente ese tipo de análisis: identificar qué está mal, proponer cambios concretos y medir resultados en 30 días.
