...
Si quieres profundizar en cómo tener las conversaciones difíciles cuando algo no funciona, este artículo sobre [cómo decirle a alguien que lo está haciendo mal sin perder a nadie](/blog/como-decir-que-algo-esta-mal-sin-perder-al-equipo/) te da el proceso exacto. Si antes de los objetivos tu problema es que el equipo no rinde y no sabes si es problema de ellos o tuyo, empieza por [tu equipo no rinde: ¿es su problema o el tuyo?](/blog/tu-equipo-no-rinde-es-su-problema-o-el-tuyo/). Y para que los objetivos tengan el efecto que deben tener, necesitas que detrás haya autoridad real: [liderar con autoridad sin dar miedo](/blog/liderar-con-autoridad-sin-dar-miedo/) explica cómo construirla.
