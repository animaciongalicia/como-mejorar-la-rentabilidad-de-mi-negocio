...
Bienvenido al minicurso de escandallo básico. Son 5 lecciones cortas y prácticas que te van a dar el sistema para calcular cuánto te cuesta realmente producir o vender cada cosa y, por tanto, cuánto debes cobrar para ganar dinero de verdad.

No hacen falta conocimientos previos. Solo necesitas papel, boli y las ganas de dejar de cobrar a ojo.
...
Aquí está el fallo más frecuente que veo en negocios pequeños: calcular el precio de un producto o servicio sumando solo los costes directos y visibles, olvidando una parte de los costes reales.
...
- Los costes fijos son los que pagas siempre, independientemente de las ventas.
- Los costes variables son los que solo aparecen cuando produces o vendes.
- El error más común es incluir solo los costes variables directos y olvidar repartir los costes fijos entre los productos o servicios.
- Antes de fijar ningún precio, necesitas conocer el total de tus costes fijos mensuales.
...
Si quieres trabajar el escandallo de tu negocio de forma personalizada, con tu sector, tus productos y tus números reales, en **[consultoriametodo.es](https://consultoriametodo.es)** lo hacemos juntos. La mayoría de negocios descubren oportunidades de mejora de margen del 5-15% solo con este análisis.
