...
Si aún no tienes clara la base, empieza por [separar las cuentas del negocio y las tuyas](/blog/separar-cuentas-negocio-y-personales/) y por tener claro [cuánto deberías pagarte como dueño](/blog/sueldo-dueno-negocio/). Y para no pagar más impuestos de los que corresponde mientras construyes ese patrimonio, [cómo funciona el IRPF si eres autónomo o tienes SL](/blog/irpf-autonomo-con-sl-como-funciona/) cierra el triángulo. Sin eso, no hay base sobre la que construir.
