...
const AGENTES = [
  ...
  {
    slug: 'agente-alimentacion',
    nombre: 'Agente Alimentación',
    subtitulo: 'Controla la merma y recupera el margen real',
    descripcion: 'IA especializada en negocios de alimentación fresca. Analiza tu merma producto a producto, calcula el margen real de tu surtido y construye un plan para reducir el desperdicio.',
    usos: ['Calcular margen real incluyendo merma', 'Detectar productos con más pérdidas', 'Plan de reducción de desperdicio en 60 días'],
    pilar: 'Diagnóstico',
    estado: 'disponible' as const,
    chatgptUrl: 'https://chatgpt.com/g/g-agente-alimentacion-focorentabilismo',
  },
  {
    slug: 'agente-bienestar',
    nombre: 'Agente Bienestar',
    subtitulo: 'Precios rentables para centros de salud y estética',
    descripcion: 'IA especializada en centros de salud y bienestar. Calcula el precio mínimo rentable por servicio, detecta qué está destruyendo tu margen y prepara la subida de precios sin perder clientes.',
    usos: ['Precio mínimo por servicio', 'Coste real por hora de sala', 'Comunicación de subida de tarifas'],
    pilar: 'Precios',
    estado: 'disponible' as const,
    chatgptUrl: 'https://chatgpt.com/g/g-agente-bienestar-focorentabilismo',
  },
  {
